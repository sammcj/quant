...
export const PerplexityChart = () => (
  <div className="w-full h-[700px] p-4 bg-white rounded-lg shadow-lg">
    <h2 className="text-2xl font-bold mb-4 text-center">Perplexity Increase vs Compression</h2>
    <h3 className="text-m mb-4 text-center">Lower <span className="text-purple-500">perplexity</span> is better, Higher <span className="text-green-500">compression</span> is better</h3>
    <h4 className="text-s mb-4 text-center">A perplexity of 0.01% or lower is ideal, 0.05% or less is generally considered acceptable.</h4>
    <ResponsiveContainer width="100%" height="100%">
      <LineChart
        data={perplexityData}
      ...
      >
        ...
        <ReferenceLine y={0.01} yAxisId="left" stroke="none" label={<GoodLabel stroke="red" value="Ideal (<0.01)" xOffset={10} />} />
        <ReferenceLine y={0.05} yAxisId="left" stroke="none" label={<AcceptableLabel stroke="orange" value="Acceptable (<0.05)" xOffset={10} />} />
      </LineChart>
    </ResponsiveContainer>
  </div>
);
...
export const QuantisationChart = () => (
  <div className="w-full h-[650px] p-4 bg-white rounded-lg shadow-lg">
    ...
    <ResponsiveContainer width="100%" height="100%" style={{ paddingBottom: '70px' }}>
      <ComposedChart
      ...
      >
        ...
        {/* <Line yAxisId="left" type="monotone" dataKey="quality" name="Quality (%)" stroke="#8884d8" strokeWidth={1} dot={{ strokeWidth: 2 }} /> */}
      ...
      <p className="relative bottom-10 left-0 p-4 text-l">
...
const TableSpectrum = () => {
  ...
  return (
    <div className="w-full p-4 bg-white rounded-lg shadow-lg overflow-x-auto">
      <h2 className="text-2xl font-bold mb-4 text-center">GGUF Quantisation Spectrum Heatmap</h2>
      <h3 className="text-m mb-4 text-center">Common quantisation types and their relative size, quality, and performance</h3>
      <table className="w-full text-sm">
        <thead>
...
export const QuantisationVisualisations = () => (
  <div className="container mx-auto px-4 py-8">
    <h1 className="text-3xl font-bold mb-8 text-center">GGUF Quantisation Visualisations</h1>
    <div className="mt-8 p-4 bg-blue-100 rounded-lg">
      <h2 className="text-xl font-bold mb-2">Insights on Quantisation and Model Size</h2>
      <ul className="list-disc list-inside">
